...
return [
    ...
    |--------------------------------------------------------------------------
    | Estas são as mensagens padrão de erro usadas pela classe Validator.
    | Algumas regras possuem várias versões, como as regras de tamanho.
    | Fique à vontade para ajustar conforme a necessidade do seu sistema.
    */
    ...
    'same' => 'O campo :attribute deve ser idêntico a :other.',
    'size' => [
