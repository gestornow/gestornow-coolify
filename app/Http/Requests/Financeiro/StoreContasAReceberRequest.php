...
class StoreContasAReceberRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'id_clientes' => ['nullable', Rule::exists('clientes', 'id_clientes')->where(fn ($query) => $query->where('id_empresa', session('id_empresa')))], // Segurança: restringe FK à empresa da sessão para bloquear IDOR.
    ...
    public function messages(): array
    {
        return [
            ...
            'data_pagamento.required' => 'A data de recebimento é obrigatória para contas recebidas',
            'id_forma_pagamento.required' => 'A forma de pagamento é obrigatória para contas recebidas',
        ];
    }
