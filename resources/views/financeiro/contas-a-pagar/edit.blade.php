        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Editar Conta a Pagar #{{ $conta->id_contas }}</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('financeiro.update', $conta->id_contas) }}" method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <select class="form-select select2 @error('id_fornecedores') is-invalid @enderror" 
                                    ...
                                    @foreach($fornecedores as $fornecedor)
                                        <option value="{{ $fornecedor->id_fornecedores }}" 
                                            {{ old('id_fornecedores', $conta->id_fornecedores) == $fornecedor->id_fornecedores ? 'selected' : '' }}>
                                            {{ $fornecedor->nome }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select select2 @error('id_usuario') is-invalid @enderror" 
                                    ...
                                    @foreach($funcionarios as $funcionario)
                                        <option value="{{ $funcionario->id_usuario }}" 
                                            {{ old('id_usuario', $conta->id_usuario) == $funcionario->id_usuario ? 'selected' : '' }}>
