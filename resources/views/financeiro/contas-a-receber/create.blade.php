        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Nova Conta a Receber</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('financeiro.contas-a-receber.store') }}" method="POST" id="formContaAReceber">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" 
                                    ...
                                    <option value="pago" {{ old('status') == 'pago' ? 'selected' : '' }}>Recebido</option>
                            ...
                            <div class="col-md-4" id="div_btn_gerar_parcelas" style="display: none;">
                                ...
                                <button type="button" class="btn btn-success w-100" onclick="gerarParcelasCustomizadas()">
...
<script src="{{asset('assets/js/financeiro/contas-a-receber-create.js')}}"></script>
@endsection
