...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Relatório de Contas a Receber</h5>
        <div>
            ...
            <a href="{{ route('financeiro.relatorios.contas-receber') }}" class="btn btn-sm btn-secondary">
    ...
    <div class="card-body">
        ...
        <div class="alert alert-info">
            ...
            <ul class="mb-0 mt-2">
                ...
                <li>Cliente: {{ $contas->first()->cliente->razao_social ?? '' }}</li>
                @endif
            ...
            <table class="table table-sm table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $conta->cliente->razao_social ?? '-' }}</td>
...
<form id="formRelatorioPDF" method="POST" action="{{ route('financeiro.relatorios.contas-receber.pdf') }}" style="display:none;">
    @csrf
...
<form id="formRelatorioExcel" method="POST" action="{{ route('financeiro.relatorios.contas-receber.excel') }}" style="display:none;">
    @csrf
    @foreach($filtros as $key => $value)
        @if(!empty($value))
        <input type="hidden" name="{{ $key }}" value="{{ $value }}">
