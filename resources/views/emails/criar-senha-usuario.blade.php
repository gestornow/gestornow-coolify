...
<head>
    <meta charset="utf-8" />
    <title>Defina sua Senha - GestorNow</title>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-content">
            <h2>Olá, {{ $nome }}!</h2>
            <p style="text-align: center;">Você foi adicionado como usuário na plataforma GestorNow.</p>
            <p>Para começar a usar a plataforma, defina uma senha segura para sua conta clicando no botão abaixo:</p>
            ...
            <div class="alert-note">
                 <strong>Importante:</strong> Este link expira em <strong>24 horas</strong>. Após o prazo, será necessário solicitar um novo link.
            </div>

            <p>Se o botão não funcionar, copie e cole esta URL no seu navegador:</p>
            <div class="link-box">{{ $link }}</div>

            <h3>Requisitos para sua senha:</h3>
            <ul class="list-steps">
                <li><strong>Mínimo de 8 caracteres</strong></li>
                <li><strong>Deve conter letras</strong> <span class="muted">(maiúsculas e/ou minúsculas)</span></li>
                <li><strong>Deve conter números</strong></li>
                <li><strong>Evite informações pessoais óbvias</strong> <span class="muted">(nome, data de nascimento, etc.)</span></li>
            </ul>

            <p class="muted" style="margin-top:28px; text-align: center;">
                Se você não reconhece esta ação, entre em contato com o administrador do sistema.
            </p>
        </div>
