...
<div class="container-xxl flex-grow-1">
    <ul class="nav nav-tabs mb-4">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('fornecedores.editar', $fornecedor->id_fornecedores) }}">
                <i class="ti ti-edit me-1"></i> Editar Fornecedor
            </a>
        </li>
    </ul>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1">Editar Fornecedor</h4>
            <p class="text-muted mb-0">Atualize os dados do fornecedor</p>
        </div>
    ...
    <form id="fornecedorForm" action="{{ route('fornecedores.atualizar', $fornecedor->id_fornecedores) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-label-primary">ID {{ $fornecedor->id_fornecedores }}</span>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    <input type="hidden" name="id_empresa" value="{{ $fornecedor->id_empresa }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('razao_social') is-invalid @enderror" id="razao_social" name="razao_social" value="{{ old('razao_social', $fornecedor->razao_social) }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('id_tipo_pessoa') is-invalid @enderror" id="id_tipo_pessoa" name="id_tipo_pessoa" required>
                            <option value="1" {{ old('id_tipo_pessoa', $fornecedor->id_tipo_pessoa) == '1' ? 'selected' : '' }}>Pessoa Fisica</option>
                            <option value="2" {{ old('id_tipo_pessoa', $fornecedor->id_tipo_pessoa) == '2' ? 'selected' : '' }}>Pessoa Juridica</option>
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control @error('cpf_cnpj') is-invalid @enderror" id="cpf_cnpj" name="cpf_cnpj" value="{{ old('cpf_cnpj', $fornecedor->cpf_cnpj) }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('rg_ie') is-invalid @enderror" id="rg_ie" name="rg_ie" value="{{ old('rg_ie', $fornecedor->rg_ie) }}">
                        @error('rg_ie')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>

                    <div class="col-md-4">
                        <label class="form-label" for="email">Email</label>
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $fornecedor->email) }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" class="form-control @error('data_nascimento') is-invalid @enderror" id="data_nascimento" name="data_nascimento" value="{{ old('data_nascimento', $fornecedor->data_nascimento) }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status">
                            ...
                            <option value="bloqueado" {{ old('status', $fornecedor->status) == 'bloqueado' ? 'selected' : '' }}>Bloqueado</option>
                        </select>
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-7">
                        ...
                        <input type="text" class="form-control @error('endereco') is-invalid @enderror" id="endereco" name="endereco" value="{{ old('endereco', $fornecedor->endereco) }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control @error('municipio') is-invalid @enderror" id="municipio" name="municipio" value="{{ old('municipio', $fornecedor->municipio) }}">
                        @error('municipio')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>

                    <div class="col-md-1">
                        <label class="form-label" for="uf">UF</label>
                        <input type="text" class="form-control @error('uf') is-invalid @enderror" id="uf" name="uf" maxlength="2" value="{{ old('uf', $fornecedor->uf) }}">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <textarea class="form-control @error('observacoes') is-invalid @enderror" name="observacoes" id="observacoes" rows="4" placeholder="Informacoes adicionais sobre o fornecedor">{{ old('observacoes', $fornecedor->observacoes) }}</textarea>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="ti ti-device-floppy me-1"></i>Salvar Alteracoes
                    </button>
                </div>
            </div>
        </div>
