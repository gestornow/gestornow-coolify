...
return [
  ...
  // API de Arquivos (Fotos, Anexos, etc)
  'api_files_url' => env('API_FILES_URL', 'https://api.gestornow.com'),
  'api_files_checklist_upload_endpoints' => env('API_FILES_CHECKLIST_UPLOAD_ENDPOINTS', '/uploads/checklist/imagens,/api/uploads/checklist/imagens'),
  'api_files_checklist_allow_produto_fallback' => env('API_FILES_CHECKLIST_ALLOW_PRODUTO_FALLBACK', false),
];
